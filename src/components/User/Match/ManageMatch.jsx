                        ...
                        <div className="container">
                            <div className="row d-flex justify-content-center text-center">
                                <div className="col-lg-8">
                                    <h1 className="heading-title text-white">Matches</h1>
                    ...
                    <nav className="breadcrumbs">
                        <div className="container">
                            <ol>
                                ...
                                <li className="current">Matches</li>
                            </ol>
                        </div>
                    </nav>
                </div>
                                            ...
                                            match.map((el, index) => (
                                                ...
                                                <span>No Image</span>
                                                        ...
                                                        <div className="property-content">
                                                            ...
                                                            {/* <h4 className="property-title">
                                                                Seats:TotalSeats-{el.totalSeats},availableSeats-{el.availableSeats}
                                                            </h4> */}

                                                            <Link to={`/team/manage/${el._id}`} className="btn btn-primary w-100 mb-2 mt-1">
                                                                View Teams
                                                            </Link>
                                                            <br />
                                                            <Link to={`/booking/add/${el._id}`} className="btn btn-primary w-100">
                                                                Book Your Match
                                                            </Link>
                                                        </div>
                                                    </div>
