                                            ...
                                            <tr key={index}>
                                                ...
                                                <td  style={{ width: '12%' }}>
                                                    <button className="btn">
                                                        ...
                                                        /></button>
                                                    <button className="btn" onClick={() => { deleteCoach(el?._id) }}><i class="bi bi-trash-fill"></i></button>
                                                    {/* <Link to={`/admin/coach/update/${el._id}`} className="btn btn-success mx-2"> <i class="bi bi-pencil-fill"></i></Link> */}
                                                </td>
                                            </tr>
                                        ))}
